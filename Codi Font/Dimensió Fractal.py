...
diferenciar clarament de la resta (ni es poden repetir fora del contorn).

Per a fer-ho, es genereran imatges de diferents mides a partir de l'imatge que vol i se'n farà un anàl·lisi
del color dels píxels de cadascuna.

***El resultat que s'obtindrà serà només una aproximació més o menys precisa, per tant possiblement no serà el
valor real de la seva dimensió fractal***
""")
    ...
    while im is None:
        try:
            dir = easygui.fileopenbox(msg = "Tria la imatge que vols", default = r"C:\Users\{}\Desktop\*".format(user))
            im = Image.open(dir)
    ...
    dir_ims = noudir + r"Imatges_DF (eliminar després d'ús)"
    os.makedirs(dir_ims)
    ...
    dades2 = FD.DFractal((im2), (dir_ims + r"\im2.png"))
    dades4 = FD.DFractal((im4), (dir_ims + r"\im4.png"))
    dades8 = FD.DFractal((im8), (dir_ims + r"\im8.png"))
    dades16 = FD.DFractal((im16), (dir_ims + r"\im16.png"))
    dades32 = FD.DFractal((im32), (dir_ims + r"\im32.png"))
    dades64 = FD.DFractal((im64), (dir_ims + r"\im64.png"))
    dades128 = FD.DFractal((im128), (dir_ims + r"\im128.png"))
    dades256 = FD.DFractal((im256), (dir_ims + r"\im256.png"))
    dades512 = FD.DFractal((im512), (dir_ims + r"\im512.png"))
    dades1024 = FD.DFractal((im1024), (dir_ims + r"\im1024.png"))
    ...
    def print_dim():
        ...
        print ("""
Aquesta aproximació és una xifra més o menys precisa, per tant pot ser aconsellable
no prendre'l com a valor real
""")
...
""")
        ...
        if decisio_final == "1":
            ...
            pyplot.scatter(x,y)
            pyplot.xlabel("Factor Escala (mida de la imatge)")
            pyplot.ylabel("Píxels")
