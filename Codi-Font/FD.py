...
def analisi_pixels(im, path):
    ...
    print ("""
A continuació es farà l'anàlisi de la imatge {} X {}.
En total hi ha {} píxels en la imatge"
...
Obtenint colors... (pot tardar una mica)
    ...
    print ("\nIntrodueixi els números dels colors de dalt que siguin del contorn, un cada cop")
    print ("Exemple: 2")
    print ("\nPer a acabar d'escriure colors introdueixi 'atura'")
    print ("Si vol eliminar un dels colors que ha introduït, introdueixi 'elimina número'")
    ...
    while True:
        ...
        if color_contorn == "":
            print ("Introdueixi algun número o acció")
            ...
            try:
                ...
                if contorn.count(cleansedcolors[num_eliminat - 1]) == 1:
                    ...
                    print ("No ha introduït el color {}".format(cleansedcolors[num_eliminat - 1]))
            ...
            try:
                ...
                if contorn.count(cleansedcolors[color_contorn - 1]) == 0:
                    ...
                    print ("Ja ha introduït aquest color, introdueixi'n un altre")
